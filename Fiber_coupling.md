...
*	a differential xyz-translation stage ([MAX313D/M](https://www.thorlabs.com/thorproduct.cfm?partnumber=MAX313D/M#ad-image-0)) to position the fiber outlet precisely into the focal point of the coupling lens. 
    - Use the [SM1-Compatible Flexure Stage Mount](https://www.thorlabs.com/thorproduct.cfm?partnumber=HCS031) to mount the [FC/PC Fiber Adapter Plate with External SM1 threading](https://www.thorlabs.com/thorproduct.cfm?partnumber=SM1FC2) onto this stage.
...
*	Two [protected silver mirror](https://www.thorlabs.com/thorproduct.cfm?partnumber=PF05-03-P01) mounted in adjustable [mirro holders](https://www.thorlabs.com/thorproduct.cfm?partnumber=POLARIS-K05#ad-image-0) and the [posts](https://www.thorlabs.com/newgrouppage9.cfm?objectgroup_ID=9079) to align the laser with the fiber axis. Select the length of the posts compatible with the hight of the laser beam.
