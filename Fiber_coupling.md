...
## The optical path
The following schematic and [3D model that you can interactively explore in 3D](https://a360.co/3JVrDGn) shows a possible optical path for the laser coupling. You can adapt the arrangement to the space availability on your setup (mirror, **M**, lens, **L**, dichroic, **D**, wave plate, **W**, polarizer, **P**):
...
*  Install the [half-wave plate](?????????) (W2) mounted in a [high-precision rotation mount](https://www.thorlabs.com/thorproduct.cfm?partnumber=PRM1/M) to adjust the polarization of the laser. 
