...
(3) As collimination objective we use an objective optimized for near infrared transmission. The Eventhough not optimized for visible wavelength we can use the same objective also for one-photon imaging later if necessary. To 
