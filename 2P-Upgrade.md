...
*  Install the [half-wave plate](https://www.newport.com/p/10RP52-2B) (W2) mounted in a [high-precision rotation mount](https://www.thorlabs.com/thorproduct.cfm?partnumber=PRM1/M) to adjust the polarization of the laser.  For the highest signal in two-photon microscopy, you want to align the laser polarisation into the light-sheet plane. You can do this later by rotating this waveplate until you have maximal fluorescence. 
