...
* Now drive the galvometer with a saw tooth pattern via a function generator or the [coomputer software](Software.md) to generate the light-sheet. Adjust the amplitude of the movement such that the light-sheet covers exactly the field of view. 
* Trouble shooting: 
